...
# %% [markdown] {"ctype": "question", "quesnum": 1, "answer": "B"}
...
# %% [markdown] {"answer": "B", "ctype": "question", "quesnum": 1}
# **Q1 answer B)**
#
# \begin{align*}
...
# %% {"answer": "B", "ctype": "answer", "quesnum": 1}
-5.0e5 * (-1.0e-6)  # B

# %% [markdown] {"ctype": "question", "quesnum": 2, "answer": "D"}
...
# %% {"answer": "D", "ctype": "question", "quesnum": 2}
f = -1 / 0.65
f_new = f + 0.25
lambda_new = 1 / f_new
print(lambda_new, f_new)  # D

# %% [markdown] {"ctype": "question", "quesnum": 3, "answer": "A"}
...
# %% {"answer": "A", "ctype": "answer", "quesnum": "3"}
D = 150
cw = 4186
rhow = 1000.0
delTemp = 0.75
...
# %% [markdown] {"ctype": "question", "quesnum": 4, "answer": "E"}
...
# %% {"answer": " ", "ctype": "question", "quesnum": " "}
3000 / 2.1  # E

# %% [markdown] {"ctype": "question", "quesnum": 5, "answer": " "}
...
# %% [markdown] {"ctype": "question", "quesnum": 6, "answer": " "}
...
# %% [markdown] {"ctype": "question", "quesnum": 7, "answer": " "}
...
# %% [markdown] {"ctype": "question", "quesnum": 8, "answer": " "}
...
# %% [markdown] {"ctype": "question", "quesnum": 8, "answer": "B"}
# #B

# %% [markdown] {"ctype": "question", "quesnum": 9, "answer": " "}
...
# %% {"answer": " ", "ctype": "question", "quesnum": 9}
-280 - 80 + 400  # B
#

# %% [markdown] {"answer": " ", "ctype": "question"}
# \begin{align}
